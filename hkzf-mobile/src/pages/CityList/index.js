...
export default class CityList extends React.Component {
    constructor(props) {
        ...
        // 创建ref对象
        this.cityListComponents = React.createRef()
    ...
    async componentDidMount() {
        ...
        this.cityListComponents.current.measureAllRows()
    }
    ...
    renderCityIndex() {
        ...
        return cityIndex.map((item, index) => (
            <li className="city-index-item" key={item} onClick={() => {
                this.cityListComponents.current.scrollToRow(index)
            }}>
     ...
     * 判断 startIndex 和 activeIndex 是否相同(判断的目的是为了提升性能, 避免不必要的state更新)
     * 当 startIndex 和 activeIndex 不同时, 更新状态 activeIndex 为 startIndx 的值 
     */
